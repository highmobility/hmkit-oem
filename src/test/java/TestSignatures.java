...
public class TestSignatures {
    ...
    @Test public void testCommand() throws CryptoException {
        ...
        PrivateKey vehiclePrivateKey = new PrivateKey("468A685967EF57ADC7FB6C51B12045722C74277C45EDD8EC005D1FF4197D6006");
        ...
        Bytes encryptedCommand = kit.encryptCommand(vehiclePrivateKey, vehicleCertificate, nonce, vehicleSerial, command);
        Bytes decryptedCommand = kit.decryptCommand(vehiclePrivateKey, vehicleCertificate, encryptedCommand);
